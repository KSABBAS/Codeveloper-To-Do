                  ...
                  child: Column(
                    children: [
                        ...
                        child: Row(
                          children: [
                            CMaker(
                                ...
                                child: Text(Task.GetLocalTaskData(widget.file, widget.index)[1]),
                            ...
                            Expanded(
                              child: CMaker(
                                alignment: Alignment.center,
                                height: 50,
                                child: Text(Task.GetLocalTaskData(widget.file, widget.index)[0]),
                              ),
                            ),
                          ],
                        ),
                      ...
                      CMaker(
                        ...
                        child: Text(Task.GetLocalTaskData(widget.file, widget.index)[2]),
